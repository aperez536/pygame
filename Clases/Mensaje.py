...
class Mensaje():
    ...
    def Print(self, msg):
        ...
        if self.Posicion == "top-left":
            ...
            msgSurfaceRect.center = (DISPLAY_ANCHO, (DISPLAY_ALTURA - msgHeight))
        else:
            #Centro - Centro
